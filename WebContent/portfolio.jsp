...
<%@ page import="java.util.Collection, java.util.Iterator, java.util.HashMap, java.math.BigDecimal,com.ibm.samples.trade.*,com.ibm.samples.trade.util.*" session="true" isThreadSafe="true" isErrorPage="false"%>
...
<table class = "simpleBorder" width = "90%">
    <TBODY>
        <TR>
            ...
            <TABLE width="100%">
                <TBODY>
                    ...
                    <TR>
                        <TD colspan="5" ><B>Portfolio </B></TD>
                        <TD align="right"><B>Number of Holdings: </B><%= holdingDataBeans.size()
%></TD>
                    </TR>
                    <TR align="center">
                        <TD colspan="6">
                        <CENTER></CENTER>
                        <TABLE class = "stockdata" border="1">
