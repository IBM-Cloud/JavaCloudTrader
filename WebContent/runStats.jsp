...
<%@ page import="com.ibm.samples.trade.*" session="false" isThreadSafe="true" isErrorPage="false" %>

<jsp:useBean class="com.ibm.samples.trade.RunStatsDataBean" id="runStatsData" scope="request" />
<% 
